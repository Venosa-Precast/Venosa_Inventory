        ...
        <div class="container">
            <div class="row text-black">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-1">
                    <div class="px-1">
					<h3>Inventory Add</h3>
                        <form action="inventorysubmit.php" method="post" class="justify-content-center">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="How many more bags..." name="quantity" id="quantity">
								</div>
								<div class="form-group">
